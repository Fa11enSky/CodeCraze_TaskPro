...
export const CardModal = ({ initialValues = { title: '', description: '', radio: "4", date: new Date() }, newCard = true, onClose, onSubmit, isOpen }) => {
    const { title, description, date, radio } = initialValues
